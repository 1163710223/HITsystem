...
public class MainActivity extends AppCompatActivity
    ...
    public void puton(Student student){
        ...
        Log.d("MainActivity", "puton: 应该改成功了啊"+student.getId()+student.getName());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_selfmsg) {
            Intent intent = new Intent(MainActivity.this, SelfInfo.class);
            startActivity(intent);
        } else if (id == R.id.nav_classmanage) {
            //跳转至其他活动
            Intent intent = new Intent(MainActivity.this, ClassManage.class);
            startActivity(intent);
        } else if (id == R.id.nav_slideshow) {
            Intent intent = new Intent(MainActivity.this, ACDicussTopics.class);
            startActivity(intent);
    ...
    private Student requstmsg(String id){
        ...
        final String thisurl = "http://"+getString(R.string.ipdress)+"/reqteamsg?id="+id;
        //开启线程来发起网络请求
        new Thread(new Runnable() {
            @Override
            public void run() {
